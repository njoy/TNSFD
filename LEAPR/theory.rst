...
is dealt with either separately or in the translational calculation.
...
was left out, to be handled separately. If a translational term is considered, then the translational and continuous scattering law contributions are combined as follows:
