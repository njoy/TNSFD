...
Elastic thermal neutron scattering is when a neutron scatters off of some target material without creating/destroying phonons, such that no neutron energy change occurs. The incoherent approximation is used wih inelastic scattering, since accounting for inelastic coherence requires special treatment. With assuming that neutron energy *does not* change, however, coherent scattering calculations are quite feasible. 
